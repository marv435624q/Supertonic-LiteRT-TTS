...
> **상태:** 개발 중인 프로젝트이지만 일반 LiteRT CPU 경로와 지원되는 Qualcomm QNN NPU 경로는 모두 실제 사용을 염두에 두고 있습니다. 일부 기기별 호환 기능과 진단 기능은 이후에도 변경될 수 있습니다.
...
| 모델 | Backend | 4-step RTF | 4-step 실시간 대비 | 8-step RTF | 8-step 실시간 대비 |
| --- | --- | ---: | ---: | ---: | ---: |
